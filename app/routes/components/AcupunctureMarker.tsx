...
const AcupunctureMarker: React.FC = () => {
  ...
  const [imageUrl, setImageUrl] = useState<string>(""); // Full URL for database
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // 1. Create Meridian (ID is auto-generated by backend)
      ...
      const meridianResult = await addMeridian({
        meridianId: 0, // Will be ignored/auto-generated by backend
        meridianName,
      ...
      for (const marker of markers) {
        ...
        try {
          ...
          const locationResult = await addAcupointLocation({
            locationId: 0, // Backend should generate this
          ...
          const acupunctureResult = await addAcupuncture({
            acupunctureId: 0, // Backend should generate this
            acupointCode: marker.acupointCode,
            meridianId: meridianIdNum,
          });
      ...
      if (errors.length > 0) {
        ...
        // Success - reset everything and return to upload state
        setImage("");
        setImageUrl("");
        setImageFile(null);
        setMarkers([]);
